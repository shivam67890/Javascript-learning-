...
//   console.log(`hello 4`)
// }
// func1(func2);//in this firtly func1 run then it callback to func2.
...
// // error handling 
// // try{}=enclose code that might be an error..
// // catch{}=catch and handle the error.
// // finally{}=it will always run..

// try{
//   const dividend=window.prompt(`enter the number: `);
//   const divisor=window.prompt(`enter the number: `);
//   if (divisor==0){
//     throw new Error (`divisor cannot be zero -infinity`);
//   }
...
// }
// finally{
//   console.log(`it will always be printed`);

// }
// console.log(`lets make calculator`);